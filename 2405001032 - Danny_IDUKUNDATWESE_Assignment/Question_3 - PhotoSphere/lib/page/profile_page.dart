...
import 'package:photosphere/widget/profile_card.dart';
...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Profile', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),)),
      body: Column(
        children: [
          Padding(
            ...
            child: Center(
              child: Column(
                children: [
                  CircleAvatar(backgroundImage: NetworkImage(user.avatarUrl), radius: 80.0,),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(user.username),
                      const SizedBox(height: 18.0,),
                      IconButton(onPressed: () {}, icon: Icon(Icons.verified), color: Colors.blueAccent,),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('100+ Posts | 500+ Likes', style: TextStyle(fontSize: 15.0, color: Colors.blueGrey),),
                    ],
                  ),
                ],
              ),
